...
LambdaCAll = [];
LambdaCAllVF = [];
for m=1:70 % type(m-1,m-1), paper: beta/rage(m): circa 4/(0,14), 16/(0,28), 64/(0,65), 256/(0,200))
...
title_string = strcat(['Meromorphic fct in the unit disk from boundary values and interior points, $f(z) = \tan($' num2str(beta) '$z)$']);
