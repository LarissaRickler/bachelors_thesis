...
S = @(x) sGibbs([1 2 3 4],[1 1 1 1],10,x);
...
title_string = strcat(['Appr. discontinuous functions, Modified, Sawtooth']);
...
hold on 
title_string = strcat(['Appr. discontinuous functions, Modified, Sawthoot Wave']);
title(title_string,'Interpreter','LaTex','FontSize',20);
