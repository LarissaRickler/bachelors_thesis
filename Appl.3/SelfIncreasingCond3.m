...
M = 501; % # sample points, paper 1000
beta = 16; % beta = 4,16 -> 5 and 21 poles
...
title_string = strcat(['Meromorphic fct in the unit disk from boundary values, $f(z) = 100\sec($' num2str(beta) '$z)\csc($' num2str(beta) '$z)$']);
